...
“Performance Analysis of a Ray–vLLM Based Distributed System for Efficient LLM Inference” (UST–ETRI, 2025)
...
5.2 Ray Actor Cluster (RAC)

ray start --head
ray start --address=<HEAD_NODE_IP>:6379
python RayCluster_fetched.py

5.3 Ray Serve Cluster (RSC)

ray start --head
python RayServe_fetched.py

5.4 Ray + vLLM Cluster (RVC, 최종 구조)
...
이 둘의 결합이 현재 구조 중 가장 강력한 LLM 분산 서빙 해법임을 실증한다.
