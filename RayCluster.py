...
def main():
    ...
    def run_round(n_concurrent: int):
        # [MODIFICATION] ThreadPoolExecutor 대신 Ray remote call 사용
        ...
        # [수정] 분산 환경에서는 드라이버에서 측정한 latency_total로 처리량을 계산합니다.
